...
let boycottedBrands = [
    ...
    { name: "طلبات / Talabat (Delivery App)", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqcpLqoUPruJWyULn3k3tTvSPYUMKyXuML5g&s" },
    { name: "سفن دايز /7Days", image: "https://th.bing.com/th/id/OIP.PWSv6n46ve-graNIP-l1PgAAAA?w=202&h=202&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3" },
...
let alternativeBrands = [
    ...
    { name: "علي كافيه/ Ali Café", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKohWTqcCrX0rd5m7N7eJySDSKIdtPFh4vBQ&s" },
    ...
    { name: "بحر / Bahar", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpXgNFQkhxPsfVsSGDB9RuoZbRGQIy3kUCYQ&s" },
...
const soundrule=document.getElementById('sound-rule')
...
const imgRuleElement=document.getElementById('rule-image')
...
/*----------------------------- Event Listeners -----------------------------*/
  ...
  imgRuleElement.addEventListener('click',() => {  soundrule.play()})
